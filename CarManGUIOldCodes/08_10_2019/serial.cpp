...
int main(int argc, char *argv[]) {
  // iniciaComunicacao("/dev/ttyS0");
  //if (argc != 2) {
  //  erro("o nome do executável deve ser seguido pelo nome da serial, ex.: "
  //       "\"./serial /dev/tty1\"\n");
  //}
  //iniciaComunicacao(argv[1]);
  ...
  do {
    ...
    if(s == "fecha" || (file.is_open() && op == 1)) //caso a janela mande a ordem para parar de gravar o arquivo
    {
      op = 1;
      file.close();
    }
