...
void mostra_info()
{
  ...
  switch(opcao)///opcao atual
  {
    ...
    case  1:AcelConv = ((float)AcX[sensor_2]/(float)Acel_convert);display.print(AcelConv);break;
  ...
  switch(opcao)///opcao atual
  {
    ...
    case  1:AcelConv = ((float)AcY[sensor_2]/(float)Acel_convert);display.print(AcelConv);break;
  ...
  switch(opcao)///opcao atual
  {
    ...
    case  1:AcelConv = ((float)AcZ[sensor_2]/(float)Acel_convert);display.print(AcelConv);break;
